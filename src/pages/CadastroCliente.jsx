...
function CadastroCliente() {
  ...
  const validatePersonalData = () => {
    const { nomeCompleto, cpf, telefone, cepEntrega, numeroEntrega, enderecoEntrega, bairroEntrega, cidadeEntrega, ufEntrega, observacoesEntrega } = formData;
    const missingFields = [];
  ...
  return (
    <div>
      ...
      <div className="cadastro_cliente">
        ...
        <div className="tabs">
          <button className={activeTab === 'dadosPessoais' ? 'active' : ''} onClick={() => setActiveTab('dadosPessoais')}>Dados Pessoais</button>
          <button className={activeTab === 'dadosCartao' ? 'active' : ''} onClick={() => validatePersonalData() && setActiveTab('dadosCartao')}>Cartão Preferencial</button>
        </div>
        ...
        {activeTab === 'dadosPessoais' && (
          <>
            <fieldset>
              ...
              <div className="form-group">
                ...
                <div className='form-row'>
                  ...
                  <select className='cadastro-select' name="genero" value={formData.genero} onChange={handleChange} required>
            ...
            <fieldset>
              ...
              <div className="form-group">
                <div className='form-row'>
                  <input type="text" name="cepEntrega" placeholder="CEP" value={formData.cepEntrega} onChange={(e) => handleCEPChange(e, 'Entrega')} required />
                  <input type="text" name="numeroEntrega" placeholder="Número" value={formData.numeroEntrega} onChange={handleChange} required />
                </div>
                {loadingCEP && <span>Buscando CEP...</span>}
                {cepError && <span className="error">{cepError}</span>}
                <div className='form-row'>
                  <select className='cadastro-select' name="tipoEnderecoEntrega" value={formData.tipoEnderecoEntrega} onChange={handleChange} required>
                    {tiposEndereco.map((t) => <option key={t.value} value={t.value}>{t.label}</option>)}
                  </select>
                  <select className='cadastro-select' name="streetTypeEntrega" value={formData.streetTypeEntrega} onChange={handleChange} required>
                    {streetTypes.map((t) => <option key={t.value} value={t.value}>{t.label}</option>)}
                  </select>
                </div>
                <div className='form-row'><input type="text" name="enderecoEntrega" placeholder="Endereço" value={formData.enderecoEntrega} onChange={handleChange} required /></div>
                <div className='form-row'>
                  <input type="text" name="complementoEntrega" placeholder="Complemento" value={formData.complementoEntrega} onChange={handleChange} />
                  <input type="text" name="observacoesEntrega" placeholder="Apelido" value={formData.observacoesEntrega} onChange={handleChange} required />
                </div>
                <div className='form-row'>
                  <input type="text" name="bairroEntrega" placeholder="Bairro" value={formData.bairroEntrega} onChange={handleChange} required />
                  <input type="text" name="cidadeEntrega" placeholder="Cidade" value={formData.cidadeEntrega} onChange={handleChange} required />
                  <input type="text" name="ufEntrega" placeholder="UF" value={formData.ufEntrega} onChange={handleChange} required maxLength="2" />
                </div>
              </div>
            </fieldset>
            ...
            <fieldset>
              ...
              <div className="form-group">
                <label>
                  <input type="checkbox" name="enderecoCobrancaIgualEntrega" checked={formData.enderecoCobrancaIgualEntrega} onChange={handleChange} />
            ...
            <fieldset>
              ...
              <div className="form-group">
                ...
                <input type="password" name="confirmacaoSenha" placeholder="Confirmação da Senha" value={formData.confirmacaoSenha} onChange={handleChange} required />
              </div>
            </fieldset>

            <button className="buttom-form" type="button" onClick={() => validatePersonalData() && setActiveTab('dadosCartao')}>
              Próximo
            </button>
          </>
        )}
          ...
          <>
            <fieldset>
              ...
              <div className="form-group">
                ...
                <label>
                  <input type="checkbox" name="preferencialCartao" checked={formData.preferencialCartao} onChange={handleChange} />
                  <span className="checkbox-custom"></span>Cartão Preferencial
                </label>
              </div>
            </fieldset>
            <button className="buttom-form" type="submit">CADASTRAR</button>
          </>
        )}
        </form>
      </div>
