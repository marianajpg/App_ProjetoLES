...
// Registra os componentes necessários do Chart.js para a criação dos gráficos.
ChartJS.register(
  CategoryScale, LinearScale, BarElement, LineElement, PointElement, ArcElement, Title, Tooltip, Legend
);

// Página de dashboard para visualização de relatórios e dados da loja.
const Dashboard = () => {
  ...
  // Dados mockados para o gráfico de crescimento de novos clientes.
  const customerData = {
    labels: ['Janeiro', 'Fevereiro', 'Março', 'Abril', 'Maio', 'Junho'],
    datasets: [{
  ...
  // Dados mockados para o gráfico de vendas por categoria.
  const categoryData = {
    labels: ['Ficção Científica', 'Fantasia', 'Romance', 'Técnico', 'Biografia'],
    datasets: [{
      label: 'Vendas por Categoria',
      data: [300, 50, 100, 40, 120],
      backgroundColor: ['rgba(248, 97, 97, 1)', 'rgba(227, 152, 152, 1)', 'rgba(163, 7, 7, 1)', 'rgba(225, 46, 46, 1)', 'rgba(255, 115, 102, 1)'],
    }],
  };

  // Função que gera as opções de configuração para cada gráfico, incluindo um título dinâmico.
